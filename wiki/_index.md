...
> Last compiled: 2026-06-27 (child-compile 20260627-145145 — eighth verification run of the 20260611-230008 priority batch; re-pulled KB (already up to date) and re-confirmed all 20 listed priority inputs (including duplicates) are fully compiled: seed-clawd-agents.md → clawd-agent-rules.md; seed-workspace-agents.md → workspace-agent-rules.md; seed-agents-rules.md → sourced in both rules articles + nuc1-wrapper-recursion-fix.md; seed-server-state.md → nuc2-server-state.md; seed-progress-history.md → deferred (documented in kb-autofinish-autocompile-fix.md Deferred Compile Candidates); 2026-04-22-certbot-acme-fix → nginx-certbot-acme-fix.md (existing article, no new content); all 2026-04-05 research/agent-learnings → troubleshooting articles (kb-autofinish-autocompile-fix, nuc1-wrapper-recursion-fix, nuc1-repo-remote-ssh-normalization, nuc2-repo-remote-ssh-normalization). No new wiki articles or concept changes warranted. _index.md and _concepts.md confirmed current. Deferred (unchanged): seed-progress-history.md and all non-priority candidates.)
