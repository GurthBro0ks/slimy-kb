# Harness Candidates — 2026-04-22T00:28:09Z
...
- **Persistence:** 14x lifetime / 5x recent
...
- **Promotion reason:** cross_nuc_conflict
- **Persistence:** 36x lifetime / 5x recent
- **Freshness:** fresh (evidence age: 23.8h)
- **Evidence:** raw/inbox-nuc1/
- **Suggested prompt mode:** manual
- **Dispatch blocker:** advisory_only
...
- **Persistence:** 11x lifetime / 5x recent
...
- **Promotion reason:** repeated_gap
- **Persistence:** 39x lifetime / 5x recent
- **Freshness:** fresh (evidence age: 0.0h)
