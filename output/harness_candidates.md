# Harness Candidates — 2026-05-18T01:18:17Z
...
- **Persistence:** 66x lifetime / 5x recent
- **Freshness:** fresh (evidence age: 23.9h)
...
- **Promotion reason:** cross_nuc_conflict
- **Persistence:** 88x lifetime / 5x recent
- **Freshness:** fresh (evidence age: 23.9h)
- **Evidence:** raw/inbox-nuc1/
- **Suggested prompt mode:** manual
- **Dispatch blocker:** advisory_only
...
- **Persistence:** 47x lifetime / 5x recent
...
- **Promotion reason:** repeated_gap
- **Persistence:** 91x lifetime / 5x recent
- **Freshness:** fresh (evidence age: 0.0h)
...
- **Promotion reason:** repeated_gap
- **Persistence:** 63x lifetime / 5x recent
- **Freshness:** fresh (evidence age: 0.0h)
